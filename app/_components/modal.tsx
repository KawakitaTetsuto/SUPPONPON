...
const Modal = (props: ModalProps) => {
  ...
  return (
    <>
      ...
      >
        <svg className='inline' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg> 投稿しました！
      </div>
